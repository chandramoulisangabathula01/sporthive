                    ...
                    {ifLog ? (
                        <div className="relative inline-block" tabIndex={0}>
                            <button
                                ...
                                className={`inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50" ${isDropdownOpen ? 'focus:ring focus:ring-gray-400' : ''} id="menu-button" aria-expanded="true" aria-haspopup="true`}
                            > Options
