...
const Navbar: React.FC = () => {
    ...
    const isLoggedIn = userAuthCheck();
                    ...
                    {isLoggedIn ? (
                        <div className="relative inline-block" tabIndex={0}>
                            <button
                                ...
                                // className={`hover:bg-gray-800 px-3 py-2 rounded focus:outline-none transition duration-300 ${isDropdownOpen ? 'ring ring-gray-500' : ''}`}
