...
const Navbar: React.FC = () => {
  ...
  // Function to trigger a manual Sentry capture
  const handleSentryCapture = () => {
    if (window.Sentry) {
      window.Sentry.captureException(
        new Error("This is a test error captured by Sentry!")
      );
    }
  };
                      ...
                      <button className="group flex w-full items-center gap-2 rounded-lg py-1.5 px-3 data-[focus]:bg-white/10">
                        ...
                        >
                          <path
                            ...
                            strokeWidth="2"
                            d="M5.121 17.804A13.937 13.937 0 0 1 12 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 1 1-6 0a3 3 0 0 1 6 0m6 2a9 9 0 1 1-18 0a9 9 0 0 1 18 0"
                          />
                        </svg>
                        <Link to="/user">{t("User Details")}</Link>
                      </button>
                    </MenuItem>
                  )}
                  {ifLog && (
